...
const {users, grid_shape, ships_by_id, ships, guess_map} = require("./server-config.json"); //NOTE: comments are not allowed in JSON files 
...
server.on('connection', conn => {
  ...
  conn_wrapper.socket.setEncoding('utf8');
  conn_wrapper.socket.on('data', data => {
